    ...
    <View>
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          ...
          <TextInput keyboardType="number-pad" mode="outlined" label="min price" onChangeText={(val) => setData({...data, min_price: val})} />
          <TextInput
            ...
            label="max price"
            clear
            onChangeText={(val) => setData({...data, max_price: val})}
          />
          {!props.home && (
            <Button
